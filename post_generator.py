...
def main():
    ...
    try:
        ...
        for iteration in range(1, args.iterations + 1):
            ...
            print(f"Generated document word count: {word_count}")
            ...
            if args.output:
                ...
                # Append word count to the end of the document
                response_with_wordcount = response + f"\n\n---\n**Word Count: {word_count}**"
                
                output_path = Path(output_filename)
                output_path.write_text(response_with_wordcount, encoding="utf-8")
                if args.verbose:
